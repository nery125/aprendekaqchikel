...
class PalabraController extends Controller
{
    ...
    public function indexFamilia()
    {
        ...
        $familia = palabra::where("categoria_id","=",1)->paginate(100);
    ...
    public function indexSabores()
    {
        ...
        $sabores = palabra::where("categoria_id","=",2)->paginate(100);
    ...
    public function indexColores()
    {
        ...
        $colores = palabra::where("categoria_id","=",3)->paginate(100);
    ...
    public function indexPartescasa()
    {
        ...
        $partescasa = palabra::where("categoria_id","=",4)->paginate(100);
    ...
    public function indexPartescuerpo()
    {
        ...
        $partescuerpo = palabra::where("categoria_id","=",5)->paginate(100);
    ...
    public function indexUtilesescolares()
    {
        ...
        $utilesescolares = palabra::where("categoria_id","=",6)->paginate(100);
    ...
    public function indexNumeros()
    {
        ...
        $numeros = palabra::where("categoria_id","=",7)->paginate(100);
    ...
    public function indexAnimales()
    {
        ...
        $animales = palabra::where("categoria_id","=",8)->paginate(100);
    ...
    public function indexmesano()
    {
        ...
        $mesano = palabra::where("categoria_id","=",9)->paginate(100);
    ...
    public function indextrasporte()
    {
        ...
        $trasporte = palabra::where("categoria_id","=",10)->paginate(100);
    ...
    public function indexprofesion()
    {
        ...
        $profesion = palabra::where("categoria_id","=",11)->paginate(100);
    ...
    public function indexfrutas()
    {
        ...
        $frutas = palabra::where("categoria_id","=",12)->paginate(100);
    ...
    public function indexverduras()
    {
        ...
        $verduras = palabra::where("categoria_id","=",13)->paginate(100);
    ...
    public function indextiempo()
    {
        ...
        $tiempo = palabra::where("categoria_id","=",14)->paginate(15);
    ...
    public function indexEstadotiempo()
    {
        ...
        $estadotiempo = palabra::where("categoria_id","=",15)->paginate(100);
